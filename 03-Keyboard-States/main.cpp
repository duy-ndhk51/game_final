...
void LoadResources()
{
	...
	textures->Add(ID_TEX_MARIO, L"textures\\main_character.png", D3DCOLOR_XRGB(176, 224, 248));
	...
	sprites->Add(10001, 3, 30, 10, 45, main);
	sprites->Add(10002, 12, 30, 19, 45, main);
	sprites->Add(10003, 21, 30, 28, 45, main);
	sprites->Add(10004, 30, 30, 37, 45, main);
