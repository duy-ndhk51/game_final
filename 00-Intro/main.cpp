...
#define BRICK_START_VX 5.0f
#define BRICK_WIDTH 16.0f

#define BRICK_START_XX 30.0f
#define BRICK_START_YX 10.0f
#define BRICK_START_VXX 5.0f
#define BRICK_WIDTH_X 20.0f
...
void Render()
{
	if (d3ddv->BeginScene())
	{
		...
		D3DXVECTOR3 p(brick_x, brick_y, 0);
		D3DXVECTOR3 p1(60.0f, 50.0f, 0);
		spriteHandler->Draw(texBrick, NULL, NULL, &p, D3DCOLOR_WHITE);
		spriteHandler->Draw(texBrick, NULL, NULL, &p1, D3DCOLOR_WHITE);

		DebugOutTitle(L"debugouttitle %s (%0.2f,%0.3f) v:%0.1f", WINDOW_TITLE, brick_x, brick_y, brick_vx);
